...
var hljs = (() => {
	...
	function W(e) {
		...
		if (e.compilerExtensions || (e.compilerExtensions = []), e.contains?.includes('self')) {
	...
	const V = t,
		...
		Y = Symbol('nomatch'),
		ee = t => {
			let a = Object.create(null), i = Object.create(null), r = [];
			let s = !0;
	...
	function be(e, n, t) {
		return -1 === t ? '' : e.replace(n, _a => be(e, n, t - 1));
	}
	...
	var Ue = Object.freeze({
		...
		grmr_plaintext: _e => ({ name: 'Plain text', aliases: ['text', 'txt'], disableAutodetect: !0 }),
		grmr_python: e => {
			const n = e.regex,
