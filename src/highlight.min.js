			...
			function t(r, s) {
				...
				return 'object' == typeof r.keywords && r.keywords.$pattern
					...
					r.contains = [].concat(...r.contains.map(e =>
						(e => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map(n =>
							a(e, {
								variants: null,
							}, n)
						)),
		...
		ee = t => {
				...
				function w(a, r) {
					...
					if (y = r, 'begin' === r.type) {
						return (e => {
							...
							return a.skip ? S += t : (a.excludeBegin && (S += t), d(), a.returnBegin || a.excludeBegin || (S = t)),
								b(a, e),
			...
			function y(e) {
				...
				const t = (e => {
					...
					if (t) {
						const n = N(t[1]);
						return n || (K(o.replace('{}', t[1])), K('Falling back to no-highlight mode for this block.', e)),
							n ? t[1] : 'no-highlight';
					}
			...
			Object.assign(t, {
				...
				highlightElement: y,
				highlightBlock:
					e => (q('10.7.0', 'highlightBlock will be removed entirely in v12.0'),
