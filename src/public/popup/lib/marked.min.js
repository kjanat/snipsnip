...
export default (() => {
	...
	function Y(l, e) {
		let t = l.replace(m.findPipe, (_i, r, o) => {
				let a = !1, c = r;
				for (; --c >= 0 && o[c] === '\\';) a = !a;
				return a ? '|' : ' |';
			}),
	...
	function me(l, e, t, n, s) {
		const i = e.href, r = e.title || null, o = l[1].replace(s.other.outputLinkReplace, '$1');
		n.state.inLink = !0;
		const a = {
...
`,
		...
		fences(e) {
			...
			if (t) {
				const n = t[0], s = rt(n, t[3] || '', this.rules);
				return {
					type: 'code',
					raw: n,
			...
			if (t) {
				...
				return s = s.trim(),
					...
					me(
						t,
						{
							href: s?.replace(this.rules.inline.anyPunctuation, '$1'),
		...
		emStrong(e, t, n = '') {
			...
			if (!(s[1] || s[2] || '') || !n || this.rules.inline.punctuation.exec(n)) {
				...
				for (u.lastIndex = 0, t = t.slice(-1 * e.length + r); (s = u.exec(t)) != null;) {
					...
					if (c -= a, c > 0) continue;
					a = Math.min(a, a + c + p);
					const d = [...s[0]][0].length, g = e.slice(0, r + s.index + d + a);
					if (Math.min(r, a) % 2) {
						const f = g.slice(1, -1);
...
`;
		...
		link({ href: e, title: t, tokens: n }) {
			const s = this.parser.parseInline(n), i = V(e);
			if (i === null) return s;
			e = i;
			let r = `<a href="${e}"`;
		...
		parse(e, t = !0) {
			...
			for (let s = 0; s < e.length; s++) {
				...
				if (this.options.extensions?.renderers?.[i.type]) {
					const o = i, a = this.options.extensions.renderers[o.type].call({ parser: this }, o);
					if (
						a !== !1
			...
			return e.forEach(n => {
				...
				if (
					...
					for (const r in n.renderer) {
						...
						const o = r, a = n.renderer[o], c = i[o];
						i[o] = (...p) => {
							let u = a.apply(i, p);
				...
				if (n.tokenizer) {
					...
					for (const r in n.tokenizer) {
						...
						const o = r, a = n.tokenizer[o], c = i[o];
						i[o] = (...p) => {
							let u = a.apply(i, p);
							return u === !1 && (u = c.apply(i, p)), u;
						};
