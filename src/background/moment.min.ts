!function(e, t) {
	...
	function A(e) {
		if (null == e._isValid) {
			var t = m(e),
				...
				n = !isNaN(e._d.getTime()) && t.overflow < 0 && !t.empty && !t.invalidEra && !t.invalidMonth
					&& !t.invalidWeekday && !t.weekdayMismatch && !t.nullInput && !t.invalidFormat && !t.userInvalidated
	...
	function dt(t) {
		var e;
		if (
			void 0 === R[t] && 'undefined' != typeof module && module && module.exports && null != t.match('^[^/\\\\]*$')
		) {
			try {
		...
		if (!e._d) {
			for (
				s = e,
					...
					e._w && null == e._a[b] && null == e._a[O] && (null != (i = (s = e)._w).GG || null != i.W || null != i.E
						? (u = 1,
							l = 4,
	...
	i.add = Ce,
		...
		i.inspect = function() {
			...
			var e, t = 'moment', n = '';
			return this.isLocal() || (t = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone', n = 'Z'),
				t = '[' + t + '("]',
		...
		i.utcOffset = function(e, t, n) {
			...
			if ('string' == typeof e) { if (null === (e = Vt(Ye, e))) return this; }
	...
	function mn(e, t, n, s) {
		t =
			('boolean' == typeof e ? u(t) && (n = t, t = void 0) : (t = e, e = !1, u(n = t) && (n = t, t = void 0)), t || '');
		...
		w.monthsParse = function(e, t, n) {
			...
			if (this._monthsParseExact) {
				return function(e, t, n) {
					...
					return n
						? 'MMM' === t
							? -1 !== (i = S.call(this._shortMonthsParse, e)) ? i : null
							: -1 !== (i = S.call(this._longMonthsParse, e))
							? i
							: null
						: 'MMM' === t
						? -1 !== (i = S.call(this._shortMonthsParse, e)) || -1 !== (i = S.call(this._longMonthsParse, e)) ? i : null
		...
		w.weekdaysParse = function(e, t, n) {
			...
			if (this._weekdaysParseExact) {
				return function(e, t, n) {
					...
					return n
						? 'dddd' === t
							? -1 !== (i = S.call(this._weekdaysParse, e)) ? i : null
							: 'ddd' === t
							? -1 !== (i = S.call(this._shortWeekdaysParse, e)) ? i : null
							: -1 !== (i = S.call(this._minWeekdaysParse, e))
							? i
							: null
						: 'dddd' === t
						? -1 !== (i = S.call(this._weekdaysParse, e)) || -1 !== (i = S.call(this._shortWeekdaysParse, e))
								|| -1 !== (i = S.call(this._minWeekdaysParse, e))
							? i
							: null
						: 'ddd' === t
						? -1 !== (i = S.call(this._shortWeekdaysParse, e)) || -1 !== (i = S.call(this._weekdaysParse, e))
								|| -1 !== (i = S.call(this._minWeekdaysParse, e))
							? i
							: null
						: -1 !== (i = S.call(this._minWeekdaysParse, e)) || -1 !== (i = S.call(this._weekdaysParse, e))
	...
	function bn(e, t, n, s) {
		var i = C(e).abs(),
			...
			h = Yn(i.as('w')),
			i = Yn(i.as('y')),
			r = (r <= n.ss ? ['s', r] : r < n.s && ['ss', r]) || a <= 1 && ['m'] || a < n.m && ['mm', a] || o <= 1 && ['h']
				|| o < n.h && ['hh', o] || u <= 1 && ['d'] || u < n.d && ['dd', u];
		return (r = (r = null != n.w ? r || h <= 1 && ['w'] || h < n.w && ['ww', h] : r) || l <= 1 && ['M']
			|| l < n.M && ['MM', l] || i <= 1 && ['y'] || ['yy', i])[2] = t,
			r[3] = 0 < +e,
			r[4] = s,
			function(e, t, n, s, i) {
	...
	function Nn() {
		...
		return h
			? (e = y(o / 60),
				...
				(h < 0 ? '-' : '') + 'P' + (n ? i + n + 'Y' : '') + (l ? i + l + 'M' : '') + (u ? r + u + 'D' : '')
				+ (t || e || o ? 'T' : '') + (t ? a + t + 'H' : '') + (e ? a + e + 'M' : '') + (o ? a + s + 'S' : ''))
			: 'P0D';
	}
	var U = Ct.prototype;
