((a, b) => {
...
})('undefined' === typeof globalThis ? 'undefined' === typeof self ? this : self : globalThis, (a) => {
	if ('undefined' === typeof browser || Object.getPrototypeOf(browser) !== Object.prototype) {
		...
		a.exports = (a => {
			...
			const j = (a, b = {}, c = {}) => {
					const d = Object.create(null), e = Object.create(a);
					return new Proxy(e, {
						has(_b, c) {
			...
			const n = new c(a =>
				...
				o = ({ reject: b, resolve: c }, d) => {
					a.runtime.lastError
						...
						: d?.__mozWebExtensionPolyfillReject__
